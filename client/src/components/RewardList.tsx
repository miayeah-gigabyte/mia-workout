// client/src/components/RewardsList.tsx
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-gray-800 mb-1">{reward.rewardName}</h3> 
                <p className="text-gray-500 text-sm">Unlocked on {formatDate(reward.unlockedAt)}</p> 
              </div>
            </div>
          </div>
        ))
